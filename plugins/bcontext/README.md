...
- `skills/bcontext/` — the behavior pack: scoped RAG, reusable tags, semantic hierarchy, the 409 rebase loop, block refs, `blocked_by` edges, and `list_changes` re-sync.
